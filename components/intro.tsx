  ...
  return (
    ...
    >
      ...
      >
        {language === 'EN' ? (
          <>
          <span className="font-bold">Hello, I'm Amienul Rana.</span> I'm a{" "}
          ...
          <span className="underline">React (Next.js) & React Native</span>.
            ...
            <>
            <span className="font-bold">Halo, saya Amienul Rana.</span> Saya seorang{" "}
            <span className="font-bold">Frontend Developer</span> dengan{" "}
            <span className="font-bold">pengalaman 2 tahun lebih</span>. Saya senang dalam membuat{" "}
            <span className="italic">website & aplikasi</span>. Fokus saya adalah{" "}
            <span className="underline">React (Next.js) & React Native</span>.
          </>
        )}
      </motion.h1>
